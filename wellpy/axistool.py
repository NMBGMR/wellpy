...
AxisView = View(VGroup(
        ...
        Group(
                ...
                Item("wrapper.tick_label_font", label="Font", editor=FontEditor()),
...
class WrapAxis(HasTraits):
    ...
    def __init__(self, comp, *args, **kw):
        ...
        self.tick_label_font = str(comp.tick_label_font)
        self.on_trait_change(self._update_tick_label_font, 'tick_label_font')

    def _update_tick_label_font(self, *args, **kw):
        self._comp.tick_label_font = str(self.tick_label_font)
